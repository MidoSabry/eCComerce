...
public class ResetPasswordActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        if(check.equals("settings"))
        {
            ...
            titleQuestion.setText("Answer the following sequrity question");
    ...
    private void setAnswer(){
        ...
        {
            Toast.makeText(ResetPasswordActivity.this, "Answer both question", Toast.LENGTH_SHORT).show();
        }
        else
        {
            ...
            ref.child("Security Questions").updateChildren(userdataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    ...
                    {
                        Toast.makeText(ResetPasswordActivity.this, "you have set answer security question successfully.", Toast.LENGTH_SHORT).show();
    ...
    private void verifyUser(){
            ...
            ref.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if(dataSnapshot.exists())
                    {
                        ...
                        {
                            Toast.makeText(ResetPasswordActivity.this, "you have not set the sequrity question.", Toast.LENGTH_SHORT).show();
                        }
                    }
                    else
                    {
        ...
        {
            Toast.makeText(this, "Answer the following question.", Toast.LENGTH_SHORT).show();
        }
