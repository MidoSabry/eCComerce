...
public class AdminAddNewProductActivity extends AppCompatActivity {
    ...
    private String Description, Price, Pname, saveCurrentData, saveCurrentTime;
    ...
    private void OpenGallery() {
        ...
        startActivityForResult(gellaryIntent,GalleryPick);
    }
    ...
    private void StoreProductInformation() {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(AdminAddNewProductActivity.this, "Produt Image uploaded successfully.....", Toast.LENGTH_SHORT).show();
                Task<Uri> uriTask =uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if(task.isSuccessful())
                        {
                            ...
                            Toast.makeText(AdminAddNewProductActivity.this, "got the Product image URL save to database successfully", Toast.LENGTH_SHORT).show();

                            SaveProductInformationDatabase();
                        }
                    }
                });
            }
    ...
    private void SaveProductInformationDatabase() {
